...
#define CUSTOM_MACHINE_NAME "POLY"
...
#define HOMING_FEEDRATE {15*60, 15*60, 5*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {644.1,644.1,644.1,98}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {20, 20, 2, 25}    // (mm/sec)
